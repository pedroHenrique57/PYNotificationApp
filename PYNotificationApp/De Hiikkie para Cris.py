...
# Variáveis
frases__pro__cris = [
    "Poder ficar ao seu lado é um presente que eu valorizo e tenho muita sorte de poder dizer isso, eu te amo vida ❤🧡",
    "Eu amo você de um tantãoooooo assimmm: ∞^∞ \n (É infinito a potência de infinito :p)",
    "Você é o meu safe spot e minha maior felicidade, obrigado por ser incrível amor.",
    ...
    "também meu pretinho.",
    "Eu gosto do jeito que você faz as coisas e como você faz eu me sentir amado e cuidado.",
    ...
    "Eu sou muito grato por poder compartilhar minha vida com você, e quero que você faça parte dela para sempre.",
    ...
    "Você faz meu mundo girar e meu coração falar.",
...
icones__para__mensagens = [
    "assets/img/dragon1.ico",
    "assets/img/dragon2.ico",
    "assets/img/dragon3.ico",
    "assets/img/dragon4.ico",
    "assets/img/dragon5.ico"
]
